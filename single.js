...
let sproduct=mirrors.find(function(e){
...
container.innerHTML=` <div class="col-md-3">
                <div id="productCarousel" class="carousel slide" data-bs-ride="carousel">
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            <img src="${sproduct.image}" class="d-block w-100 img-fluid" alt="Product Image 1">
                        </div>
                    </div>
            ...
            <div class="col-md-9">
                ...
                <p class="h3 text-primary mb-4">Rs.${sproduct.price}</p>
                <p>${sproduct.description}</p>
                <p><b>Material Type: </b>${sproduct.materialType}</p>
                <p><b>Mirror Type: </b>${sproduct.mirrorType}</p>
