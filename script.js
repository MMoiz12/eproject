...
let mirrorsWithRatings = mirrors.map(item => ({
  ...
  for(let i = 0; i <mirrors.length;i++){
        ...
        <a class="btn btn-primary float-end h-25" href="./singleproduct.html?id=${mirrors[i].id}" role="button">Exlore More</a>
        </p>
 ...
 function filters(material) {
      ...
      for (let i = 0; i < filter.length; i++) {
        ...
        <a class="btn btn-primary float-end h-25" href="./" role="button">Explore More</a>
        </p>
     ...
     function filters2(material2) {
      ...
      for (let i = 0; i < filter2.length; i++) {
        ...
        <a class="btn btn-primary float-end h-25" href="./singleproduct.html?id=${filter2[i].id}" role="button">Explore More</a>
        </p>
